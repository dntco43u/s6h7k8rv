...
user=HR
pass=BYtKbOvYUogmt8RJHAOCM2e2GJGWq1
url="'(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1521)(host=adb.ap-seoul-1.oraclecloud.com))(connect_data=(service_name=g0c3c31b1ace251_dwc8khum_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))'"
docker run \
